        ...
        <div className="traffic-controls animate-in">
          <form onSubmit={handleSearch} className="traffic-form">
            <div className="form-group">
              ...
              <input id="traffic-origin" type="text" placeholder="Enter starting point" value={origin} onChange={e => setOrigin(e.target.value)} required />
            </div>
            <div className="form-group">
              <label htmlFor="traffic-dest">Destination</label>
              <input id="traffic-dest" type="text" placeholder="Enter destination" value={destination} onChange={e => setDestination(e.target.value)} required />
            </div>

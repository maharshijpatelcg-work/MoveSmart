        ...
        <div className="modal-overlay" onClick={() => setShowCreate(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleCreate} className="modal__form">
              <div className="form-group"><label htmlFor="route-name">Route Name</label><input id="route-name" type="text" placeholder="e.g., Home → Office" value={newRoute.name} onChange={(e) => setNewRoute({ ...newRoute, name: e.target.value })} required /></div>
              <div className="form-group"><label htmlFor="route-origin">Origin</label><input id="route-origin" type="text" placeholder="Starting location" value={newRoute.origin} onChange={(e) => setNewRoute({ ...newRoute, origin: e.target.value })} required /></div>
              <div className="form-group"><label htmlFor="route-dest">Destination</label><input id="route-dest" type="text" placeholder="End location" value={newRoute.destination} onChange={(e) => setNewRoute({ ...newRoute, destination: e.target.value })} required /></div>
              <div className="form-group"><label htmlFor="route-stops">Number of Stops</label><input id="route-stops" type="number" placeholder="0" min="0" max="20" value={newRoute.stops} onChange={(e) => setNewRoute({ ...newRoute, stops: e.target.value })} /></div>
